...
from a frozen activity classifier. We evaluate BeamDiff in the HAR-1 and HAR-3
environments of the CSI-BFI-HAR dataset using fixed real validation and test
sets and one-to-one training-data augmentation. On HAR-1, the mean BeamSense
