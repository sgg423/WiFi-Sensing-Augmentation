...
|---|---:|---:|---:|---:|---:|---:|
| SenseFi LeNet 기반 | 28,876 | 6,188 | 6,188 | 85.13% | 84.97% | 85.12% |
| SenseFi ResNet18 기반 | 28,876 | 6,188 | 6,188 | **95.10%** | **95.20%** | **95.30%** |

이를 통해 HAR-1 단일 링크 CSI 진폭에도 20개 행동을 구분할 수 있는 센싱 정보가 존재함을 확인하였다. LeNet과 ResNet18 사이의 성능 차이는 분류 모델의 영향이 크다는 점도 보여준다.

### CSI·BFI 기준 성능 요약

| 데이터 | 센싱 표현 | 공개 모델 기반 분류기 | Accuracy | Macro-F1 | Macro-recall |
|---|---|---|---:|---:|---:|
| CSI | 진폭 `(1, 250, 90)` | SenseFi ResNet18 | 95.10% | 95.20% | 95.30% |
