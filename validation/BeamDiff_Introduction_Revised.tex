...
We evaluate BeamDiff in the HAR-1 and HAR-3 environments of the CSI-BFI-HAR
dataset using paired real-only and real-plus-synthetic training protocols. The
real validation and test folds remain fixed, and only the training folds are
augmented. This evaluation examines generated-data fidelity, downstream sensing
performance, and robustness across model initialization seeds.
