...
Classroom scenarios provided by the CSI-BFI-HAR dataset
\cite{haque2026datasets}. We compare paired real-only and real-plus-synthetic
training protocols while keeping the real validation and test folds fixed and
augmenting only the training folds. This evaluation examines generated-data
fidelity, downstream sensing performance, and robustness across model
